...
public class ParkManager
{
    ...
    {
        if (_park1.Margin > 0 && !_park1.IsHasCar(carId) && _park1.Margin <= _park2.Margin)
        {
            return _park1;
        }
        else if (_park2.Margin > 0 && !_park2.IsHasCar(carId) && (_park2.Margin < _park1.Margin || _park1.Margin == 0))
        {
            return _park2;
        }
